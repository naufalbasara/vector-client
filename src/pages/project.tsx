...
export default function Project() {
  ...
  const submitState = async () => {
    const response = await fetch('https://backend.thinger.io/v3/users/rtaufiqulrtrh/devices/Vector/resources/stringResource', {
      method: 'POST',
      headers: {
    ...
    <Layout>
      ...
      <main className='min-h-screen pt-32 flex flex-col items-center text-center'>
          ...
          <div className='m-4 w-full flex justify-center items-center h-20 bg-gray-400'>
            ...
            <Button className='bg-[#2CA87F] hover:bg-gray-500' onClick={submitState}>Submit</Button>
          </div>
